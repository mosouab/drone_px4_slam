...
int main() {
    ...
    int land_command_sent = 0;
    int disarm_command_sent = 0;
                    ...
                    if (msg.msgid == MAVLINK_MSG_ID_HEARTBEAT) {
                        if (!connection_established) {
                            ...
                            send_command_long(sock, &targetAddr, target_system, target_component,
                                              ...
                                              0.0f, NAN, NAN, 0.0f);
                            land_command_sent = 1;
                            printf("Commande LAND envoyée. Attente confirmation d'atterrissage...\n");
                        }
                    }
                }
            }
